...
### Final deliverables
- [ ] Socket opens once per session, survives every route transition.
- [ ] `useSocketEvent` is fully typed; payload mismatches fail compilation.
- [ ] Reconnect UI appears and disappears correctly.
- [ ] `SyncController` mounts above the router and unmounts cleanly on logout.
...
### Final deliverables
- [ ] Page reload paints last-known UI before the network resolves.
- [ ] Logout wipes Dexie.
...
### Final deliverables
- [ ] Chat list renders 1000 items at 60fps.
- [ ] Real-time updates appear without manual refresh.
- [ ] Filters survive reload.
- [ ] Right-click menu, mute, mark-read all work.
...
### Final deliverables
- [ ] Sending feels instant; reconciliation produces exactly one rendered message.
- [ ] Edit/delete/react/forward work optimistically with rollback on error.
- [ ] 10k messages render and scroll smoothly.
- [ ] Media decrypted lazily and cached.
- [ ] In-chat search highlights and navigates.
